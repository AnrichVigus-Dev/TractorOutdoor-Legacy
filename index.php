...
<!-- Body Content -->
<section class="sme-body-container body-container">

   <h1>SME Page and chatbot</h1> 
      <p>
      ...
      <button onclick="window.location.href='company-info.php';" class="start-process-btn" style="float:right">Start Process</button>   
...
<div class="botIcon">
	<div class="botIconContainer">
		<div class="iconInner">
			<i class="fa fa-commenting" aria-hidden="true"><span>Start</span></i>
		</div>
	</div>
	<div class="Layout Layout-open Layout-expand Layout-right">
		<div class="Messenger_messenger">
			<div class="Messenger_header">
				<h4 class="Messenger_prompt">How can we help you?</h4> <span class="chat_close_icon">X</span>
			</div>
